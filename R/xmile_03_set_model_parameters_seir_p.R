set_model_parameters_xmile <- function(p){
	...
	sim_state$End_Time_of_Physical_Distancing  <- get_param(p,'End_Time_of_Physical_Distancing') 
	...
	sim_state$Physical_Distancing_Policy_Flag  <- get_param(p,'Physical_Distancing_Policy_Flag') 
	...
	sim_state$Start_Time_of_Physical_Distancing  <- get_param(p,'Start_Time_of_Physical_Distancing') 
